		...
		<div align="center">
			...
			<table border="2" width="500">
				<tr>
					<th>제목</th>		
				<td>
				<textarea name="comments" id="" cols="30"row="10"></textarea>	
				</td>			
				</tr>
	    	<tr> 
	    	<td colspan='2'>
	   		<textarea name="title" id="utitle" rows="10" cols="55" placeholder="내용쓰기" maxlength="100" required></textarea>
      	     </td>
      		</tr>
		    ...
		    <textarea name="title" id="utitle" rows="5" cols="55" placeholder="댓글달기" maxlength="100" required></textarea></td> 
